...
- **FR-006**: User-facing interfaces MUST provide keyboard access, visible focus, readable contrast, clear labels, clear error messages, and non-color-only signaling
